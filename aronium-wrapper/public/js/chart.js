...
!(function (t, e) {
            ...
            const n = (function (t, e) {
                ...
                for (
                    ...
                    (u && M !== a
                        ? (i.push({ value: a }),
                          M < a && D++,
                          V(Math.round((M + D * S) * v) / v, a, mo(a, y, t)) &&
                              D++)
                        : M < a && D++);
                    D < k;
                    ++D
        ...
        t.setCenterPoint(e.l - i.l, i.r - e.r, e.t - i.t, i.b - e.b),
            (t._pointLabelItems = (function (t, e, i) {
                ...
                for (let o = 0; o < n; o++) {
                    ...
                    s.push(n),
                        "auto" === r &&
                            ((n.visible = Ao(n, h)), n.visible && (h = n));
                }
                return s;
            })(t, s, o));
    }
            ...
            return (
                ...
                (this._majorUnit =
                    i.major.enabled && "year" !== this._unit
                        ? (function (t) {
                              for (
                                  let e = Io.indexOf(t) + 1, i = Io.length;
                                  e < i;
                                  ++e
                              )
    ...
    class Va extends Hs {
        ...
        getTitle(t, e) {
            ...
            let a = [];
            return (
                (a = Pa(a, Da(s))), (a = Pa(a, Da(n))), (a = Pa(a, Da(o))), a
            );
        }
        getBeforeBody(t, e) {
